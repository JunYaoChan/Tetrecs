...
public class GameBoard extends GridPane {
    ...
    /**
     * The listener to call when right clicked
     */
    ...
    protected GameBlock createBlock(int x, int y) {
        ...
        ///Add a mouse click handler to the block to trigger GameBoard blockClicked method or right clicked method
    ...
    /**
     * Triggered when is right-clicked. Call the attached listener.
     * @param event mouse event
     * @param block block clicked on
     */
    ...
    /**
     * Triggered the fade out animation on every block from the Set
     * @param blockCoordinates contains the coordinate of the block to be cleared
     */
