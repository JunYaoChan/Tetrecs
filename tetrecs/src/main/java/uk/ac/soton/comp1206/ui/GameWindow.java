...
public class GameWindow {
    ...
    public void startScore(Game game) {
            loadScene(new ScoresScene(this,game,false));
         }
    ...
    /**
     * Display the Multiplayer Score scene
     * @param game current game
     * @param isMultiplayer determine whether is multiplayer game
     * @param onlineScores store the multiplayer score
     */
    public void startMultiplayerScore(Game game, Boolean isMultiplayer,  SimpleListProperty<Pair<String, Integer>> onlineScores){
        loadScene(new ScoresScene(this,game,isMultiplayer,onlineScores));
    }
